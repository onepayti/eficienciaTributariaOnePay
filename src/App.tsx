...
export function App() {
  ...
  const impostoBruto2 =
    faturamentoMensal &&
    (faturamentoMensal - custosTotais) * (aliquotaNacional / 100);
  ...
  return (
    <>
      <div className="bg-slate-900 min-h-screen p-5 grid place-content-center max-sm:max-w-full ">
        <h1 className="text-amber-50 text-center scroll-m-20 border-b pb-2 text-3xl max-sm:text-2xl font-semibold tracking-tight  ">
          Inteligência Tributária Shield
        </h1>
        <div className=" xl:grid xl:grid-cols-2 sm:grid-cols-1 md:grid-cols-1  ">
          <div className="w-full mt-20 grid place-content-center ">
            <div className="flex gap-3">
              <h1 className=" text-amber-50">Empreendedor MEI: </h1>
            ...
            <div className="flex">
              <h1 className=" text-amber-50 ">Anexo do Simples Nacional:</h1>
              <select
        ...
        <div className="mt-20  gap-10 grid sm:grid-cols-2   ">
          <div className=" w-full ">
            <Card className=" grid place-content-between gap-10 max-sm:text-[0.9rem]    ">
              <CardHeader>
                {/* <CardTitle>Cenário 1: vendas em cartão!!</CardTitle> */}
                <CardAction>SEM EFICIÊNCIA TRIBUTÁRIA</CardAction>
              </CardHeader>
              <CardContent className="">
                <div className="flex  mb-5 place-items-center max-sm:text-[0.9rem]  ">
                  <p>Faturamento mensal declarado:</p>
                  <Input
                    className="max-w-30 bg-blue-950 text-amber-50 max-sm:text-[0.9rem]"
                ...
                <div>
                  <div className="flex place-content-between gap-4 place-items-center mt-4 ">
                    <Input
                      className=" bg-blue-950 text-amber-50 placeholder:text-amber-50 max-sm:text-[0.9rem]"
                ...
                {custos &&
                  custos.map((e, i) => {
                    return (
                      <div key={i}>
                        <div className="flex place-content-between gap-4 px-20  ">
                          <p className=" border-w-10 border-b-1 border-y-blue-950">{`${e.titulo}`}</p>
                          <span className="  border-b-1 border-y-blue-950">
                ...
                <div>
                  <div className="flex place-content-between mt-10 mb-4">
                    ...
                    <Input
                      className="max-w-20 bg-blue-950 text-amber-50 placeholder:text-amber-50 max-sm:text-[0.9rem]"
          ...
          <div className="w-full">
            <Card className=" grid place-content-between gap-10  max-sm:text-[0.9rem]  ">
              <CardHeader>
                {/* <CardTitle>Cenário 1: vendas em cartão!!</CardTitle> */}
                <CardAction className="w-70 h-10 flex justify-center items-center rounded-2xl bg-blue-950 text-amber-50">
              ...
              <CardContent className="">
                <div className="flex gap-10 mb-5 place-items-center">
                  <p>Faturamento mensal declarado:</p>
                  <span>
                    {formattedNumber(faturamentoMensal - custosTotais)}
                  </span>
                </div>
                <div className="flex gap-14 mb-5 place-items-center">
                  <p>Alíquota do Simples Nacional:</p>
                  <span>{percentFormmat(aliquotaNacional)}</span>
                </div>
                <div className="flex gap-10 mb-5">
                  <p>Faturamento mensal em cartão:</p>
                ...
                {lucroComEficiencia > 100 ? (
                  <div className="w-full grid place-content-center border-2 rounded-2xl max-sm:w-10  ">
                    <Card className="w-100 grid gap-5 bg-blue-950 text-amber-50 max-sm:w-80 ">
                      <CardHeader>
                        <CardTitle>Economia usando sua White Label:</CardTitle>
                      </CardHeader>
                      <CardContent className="w-auto grid place-content-center  ">
                        <div className="flex justify-center gap-5 ">
                          <h1 className="text-[1rem] max-sm:text-[0.9rem]">
                            Aumento do lucro em:{" "}
                          </h1>
                        ...
                        <div className="flex justify-center gap-5 ">
                          <h1 className="text-[1.0rem] max-sm:text-[0.9rem]">
                            Ganho em 12 meses:
                          </h1>
